                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                        ...
                        <div class="logo"> <a href="home.html"> <img
                                    src="{{ asset('forntendAssets') }}/assets/images/logo.png" alt="logo"> </a>
                        </div>
                        <!-- /.logo -->
                        <!-- ============================================================= LOGO : END ============================================================= -->
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-4">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="{{ asset('forntendAssets') }}/assets/images/cart.jpg"
                                                            alt=""></a> </div>
                                            </div>
                                            <div class="col-xs-7">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image">
                                                            <img class="img-responsive"
                                                                src="{{ asset('forntendAssets') }}/assets/images/banners/top-menu-banner.jpg"
                                                                alt="">
                                                        </div>
                                                        <!-- /.yamm-content -->
                                                    </div>
                                                ...
                                                <div class="yamm-content">
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            ...
                                                            <a href="#"><img alt=""
                                                                    src="{{ asset('forntendAssets') }}/assets/images/banners/banner-side.png"></a>
                                                        </div>
                                                    </div>
                                                    <!-- /.row -->
                                                </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                        ...
                        <div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
                            <div class="item">
                                <div class="products">
                                    <div class="hot-deal-wrapper">
                                        <div class="image"> <img
                                                src="{{ asset('forntendAssets') }}/assets/images/hot-deals/p25.jpg"
                                                alt=""> </div>
                            ...
                            <div class="item">
                                <div class="products">
                                    <div class="hot-deal-wrapper">
                                        <div class="image"> <img
                                                src="{{ asset('forntendAssets') }}/assets/images/hot-deals/p5.jpg"
                                                alt=""> </div>
                            ...
                            <div class="item">
                                <div class="products">
                                    <div class="hot-deal-wrapper">
                                        <div class="image"> <img
                                                src="{{ asset('forntendAssets') }}/assets/images/hot-deals/p10.jpg"
                                                alt=""> </div>
                                        <div class="sale-offer-tag"><span>35%<br>
                                                off</span></div>
                                        <div class="timing-wrapper">
                                                    ...
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p30.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p29.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p28.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p27.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p26.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p25.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p24.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p23.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p22.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p15.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p18.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p17.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p16.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p14.jpg"
                                                                        alt="">
                                                                    <div class="zoom-overlay"></div>
                                                                </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p13.jpg"
                                                                        alt="image"> </a> </div>
                                                            <!-- /.image -->
                        ...
                        <div id="advertisement" class="advertisement">
                            <div class="item">
                                <div class="avatar"><img
                                        src="{{ asset('forntendAssets') }}/assets/images/testimonials/member1.png"
                                        alt="Image"></div>
                            ...
                            <div class="item">
                                <div class="avatar"><img
                                        src="{{ asset('forntendAssets') }}/assets/images/testimonials/member3.png"
                                        alt="Image"></div>
                                <div class="testimonials"><em>"</em>Vtae sodales aliq uam morbi non sem lacus port
                                    mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em></div>
                            ...
                            <div class="item">
                                <div class="avatar"><img
                                        src="{{ asset('forntendAssets') }}/assets/images/testimonials/member2.png"
                                        alt="Image"></div>
                                <div class="testimonials"><em>"</em> Vtae sodales aliq uam morbi non sem lacus port
                                    mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em></div>
                    ...
                    <div class="home-banner"> <img
                            src="{{ asset('forntendAssets') }}/assets/images/banners/LHS-banner.jpg"
                            alt="Image"> </div>
                </div>
                <!-- /.sidemenu-holder -->
                <!-- ============================================== SIDEBAR : END ============================================== -->
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                    ...
                    <div id="hero">
                        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                            <div class="item"
                                style="background-image: url({{ asset('forntendAssets') }}/assets/images/sliders/01.jpg);">
                            ...
                            <div class="item"
                                style="background-image: url({{ asset('forntendAssets') }}/assets/images/sliders/02.jpg);">
                                <div class="container-fluid">
                                    <div class="caption bg-color vertical-center text-left">
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img
                                                                    src="{{ asset('forntendAssets') }}/assets/images/products/p1.jpg"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img
                                                                    src="{{ asset('forntendAssets') }}/assets/images/products/p2.jpg"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img
                                                                    src="{{ asset('forntendAssets') }}/assets/images/products/p4.jpg"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img
                                                                    src="{{ asset('forntendAssets') }}/assets/images/products/p3.jpg"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img
                                                                    src="{{ asset('forntendAssets') }}/assets/images/products/p5.jpg"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img
                                                                    src="{{ asset('forntendAssets') }}/assets/images/products/p6.jpg"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img
                                                                    src="{{ asset('forntendAssets') }}/assets/images/products/p7.jpg"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img
                                                                    src="{{ asset('forntendAssets') }}/assets/images/products/p8.jpg"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img
                                                                    src="{{ asset('forntendAssets') }}/assets/images/products/p9.jpg"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img
                                                                    src="{{ asset('forntendAssets') }}/assets/images/products/p10.jpg"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img
                                                                    src="{{ asset('forntendAssets') }}/assets/images/products/p11.jpg"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img
                                                                    src="{{ asset('forntendAssets') }}/assets/images/products/p12.jpg"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                    ...
                    <div class="wide-banners wow fadeInUp outer-bottom-xs">
                        <div class="row">
                            <div class="col-md-7 col-sm-7">
                                <div class="wide-banner cnt-strip">
                                    <div class="image"> <img class="img-responsive"
                                            src="{{ asset('forntendAssets') }}/assets/images/banners/home-banner1.jpg"
                                            alt=""> </div>
                                </div>
                                <!-- /.wide-banner -->
                            </div>
                            ...
                            <div class="col-md-5 col-sm-5">
                                <div class="wide-banner cnt-strip">
                                    <div class="image"> <img class="img-responsive"
                                            src="{{ asset('forntendAssets') }}/assets/images/banners/home-banner2.jpg"
                                            alt=""> </div>
                                </div>
                                <!-- /.wide-banner -->
                            </div>
                            ...
                            <div class="item item-carousel">
                                <div class="products">
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image"> <a href="detail.html"><img
                                                        src="{{ asset('forntendAssets') }}/assets/images/blank.gif"
                                                        data-echo="{{ asset('forntendAssets') }}/assets/images/products/p7.jpg"
                                                        alt=""></a> </div>
                                            <!-- /.image -->
                    ...
                    <div class="wide-banners wow fadeInUp outer-bottom-xs">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="wide-banner cnt-strip">
                                    <div class="image"> <img class="img-responsive"
                                            src="{{ asset('forntendAssets') }}/assets/images/banners/home-banner.jpg"
                                            alt=""> </div>
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p20.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img
                                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p21.jpg"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
                            ...
                            <div class="owl-carousel blog-slider custom-carousel">
                                    ...
                                    <div class="blog-post">
                                        <div class="blog-post-image">
                                            <div class="image"> <a href="blog.html"><img
                                                        src="{{ asset('forntendAssets') }}/assets/images/blog-post/post1.jpg"
                                                        alt=""></a> </div>
                                        </div>
                                        <!-- /.blog-post-image -->
                                ...
                                <div class="item">
                                    <div class="blog-post">
                                        <div class="blog-post-image">
                                            <div class="image"> <a href="blog.html"><img
                                                        src="{{ asset('forntendAssets') }}/assets/images/blog-post/post2.jpg"
                                                        alt=""></a> </div>
                                        </div>
                                        <!-- /.blog-post-image -->
                            ...
                            <div class="item item-carousel">
                                <div class="products">
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image"> <a href="detail.html"><img
                                                        src="{{ asset('forntendAssets') }}/assets/images/products/p19.jpg"
                                                        alt=""></a> </div>
                                            <!-- /.image -->
                ...
                <div class="logo-slider-inner">
                    <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
                        <div class="item m-t-15"> <a href="#" class="image"> <img
                                    data-echo="{{ asset('forntendAssets') }}/assets/images/brands/brand1.png"
                                    src="{{ asset('forntendAssets') }}/assets/images/blank.gif" alt="">
                            </a> </div>
                        <!--/.item-->

                        <div class="item m-t-10"> <a href="#" class="image"> <img
                                    data-echo="{{ asset('forntendAssets') }}/assets/images/brands/brand2.png"
                                    src="{{ asset('forntendAssets') }}/assets/images/blank.gif" alt="">
                            </a> </div>
                        <!--/.item-->

                        <div class="item"> <a href="#" class="image"> <img
                                    data-echo="{{ asset('forntendAssets') }}/assets/images/brands/brand3.png"
                                    src="{{ asset('forntendAssets') }}/assets/images/blank.gif" alt="">
                            </a> </div>
                        <!--/.item-->

                        <div class="item"> <a href="#" class="image"> <img
                                    data-echo="{{ asset('forntendAssets') }}/assets/images/brands/brand4.png"
                                    src="{{ asset('forntendAssets') }}/assets/images/blank.gif" alt="">
                            </a> </div>
                        <!--/.item-->

                        <div class="item"> <a href="#" class="image"> <img
                                    data-echo="{{ asset('forntendAssets') }}/assets/images/brands/brand5.png"
                                    src="{{ asset('forntendAssets') }}/assets/images/blank.gif" alt="">
                            </a> </div>
                        <!--/.item-->

                        <div class="item"> <a href="#" class="image"> <img
                                    data-echo="{{ asset('forntendAssets') }}/assets/images/brands/brand6.png"
                                    src="{{ asset('forntendAssets') }}/assets/images/blank.gif" alt="">
                            </a> </div>
                        <!--/.item-->
            ...
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-6 no-padding">
                    <div class="clearfix payment-methods">
                        <ul>
                            <li><img src="{{ asset('forntendAssets') }}/assets/images/payments/1.png"
                                    alt=""></li>
                            <li><img src="{{ asset('forntendAssets') }}/assets/images/payments/2.png"
                                    alt=""></li>
                            <li><img src="{{ asset('forntendAssets') }}/assets/images/payments/3.png"
                                    alt=""></li>
                            <li><img src="{{ asset('forntendAssets') }}/assets/images/payments/4.png"
                                    alt=""></li>
                            <li><img src="{{ asset('forntendAssets') }}/assets/images/payments/5.png"
                                    alt=""></li>
                        </ul>
                    </div>
                    <!-- /.payment-methods -->
